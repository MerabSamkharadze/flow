...
describe('BoardEffects', () => {
  ...
  const mockTasks: Task[] = [
    {
      ...
      createdAt: 1000, updatedAt: 2000, deadline: null, startDate: null, completedAt: null, estimatedHours: null, order: 0, labels: [], subtasks: [],
    },
    {
      ...
      createdAt: 1100, updatedAt: 2100, deadline: null, startDate: null, completedAt: null, estimatedHours: null, order: 1, labels: [], subtasks: [],
    },
    {
      ...
      createdAt: 1200, updatedAt: 2200, deadline: null, startDate: null, completedAt: null, estimatedHours: null, order: 0, labels: [], subtasks: [],
    },
  ];
  ...
  describe('addTask$', () => {
    const newTaskInput: Omit<Task, 'id'> = {
      ...
      createdAt: 3000, updatedAt: 3000, deadline: null, startDate: null, completedAt: null, estimatedHours: null, order: 2, labels: [], subtasks: [],
    };
